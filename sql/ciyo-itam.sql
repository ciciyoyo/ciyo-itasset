...
-- ----------------------------
BEGIN;
INSERT INTO `itam_device` (`id`, `model_id`, `assets_status`, `device_no`, `category_id`, `serial`, `name`, `image_url`, `purchase_date`, `purchase_cost`, `warranty_date`, `assigned_to`, `location_id`, `supplier_id`, `depreciation_id`, `description`, `create_time`, `deleted`, `update_time`, `create_by`, `update_by`) VALUES (1, 1, 4, 'DEV-LAP-0001', 35, 'SN-LAP-0001', 'ThinkPad X1 Carbon', 'https://oss.ciyocloud.cn/tduckpro/2026/01/08/2475f24aee7b44cdaf68e21e03e8c33b.png', '2024-02-10', 12000.00, '2027-02-10', 1, 1, 1, 1, '新采购未分配笔记本', '2026-01-02 16:11:49', 0, '2026-01-27 15:16:27', 1, 1);
...
INSERT INTO `itam_device` (`id`, `model_id`, `assets_status`, `device_no`, `category_id`, `serial`, `name`, `image_url`, `purchase_date`, `purchase_cost`, `warranty_date`, `assigned_to`, `location_id`, `supplier_id`, `depreciation_id`, `description`, `create_time`, `deleted`, `update_time`, `create_by`, `update_by`) VALUES (9, 1, 10, '234', 35, '234', '234', 'https://oss.ciyocloud.cn/tduckpro/2026/01/09/b63a108fdc434e2bb1a47e36d04d63c2.png', '2026-01-29', 2.00, '2026-01-31', 1, 1, 2, 1, '234', '2026-01-09 11:54:53', 1, '2026-01-26 15:11:02', 1, 1);
