...
import com.ciyocloud.common.wrapper.BodyReaderHttpServletRequestWrapper;
...
public class HttpTraceLogFilter extends OncePerRequestFilter implements Ordered {
     ...
     * @return
     */
    private final List<String> ignoreUrls = CollUtil.newArrayList("/**/api/webjars/**", "/**/swagger-resources/**", "/**/doc.html", "/**/actuator/**", "/**/captcha/**", "/**/ai/**", "/**/api/v2/api-docs");
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        boolean existsMatch = ignoreUrls.stream().anyMatch(pattern -> matcher.match(pattern, path));
        if (existsMatch || !isRequestValid(request)) {
        ...
        MDC.put("requestId", request.getHeader("x-requestId"));
    ...
    private String getResponseBody(HttpServletResponse response) {
         ...
         * 下载文件不获取
         */
        if (StringUtils.isNotBlank(response.getContentType()) && response.getContentType().equalsIgnoreCase(CommonConstants.FILE_DOWNLOAD_CONTENT_TYPE)) {
            return "";
        }
        String responseBody = "";
