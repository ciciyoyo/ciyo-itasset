    ...
    <div class="dashboard-container">
        ...
        <div class="page-header">
            <div class="header-content">
                ...
                <p class="page-subtitle">实时监控资产状态，洞察数据价值</p>
            </div>
            <div class="header-actions">
                <el-button type="primary" :icon="Refresh" circle @click="refreshAll" :loading="loading" />
            </div>
        </div>
        ...
        <div class="charts-container">
            ...
            <div class="chart-card large">
                ...
                <ArtLineChart :data="yearlyChartData" :x-axis-data="yearlyMonths" :loading="yearlyLoading"
                    :show-area-color="true" :smooth="true" :colors="chartColors" :show-legend="true" height="350px" />
            </div>
            ...
            <div class="chart-card medium">
                <div class="chart-header">
                    ...
                    <el-select v-model="selectedAssetsType" @change="handleAssetTypeChange" class="asset-type-select"
                        size="default">
                ...
                <ArtLineChart :data="monthlyChartData" :x-axis-data="monthlyMonths" :loading="monthlyLoading"
                    :show-area-color="true" :smooth="true" :colors="chartColors" height="350px" />
            </div>
            ...
            <div class="chart-card medium">
                ...
                <ArtRingChart :data="distributionChartData" :loading="distributionLoading" :show-legend="true"
                    legend-position="right" :colors="chartColors" :radius="['45%', '70%']" :border-radius="8"
                    center-text="资产分布" height="350px" />
            </div>
        </div>
    </div>
</template>
...
const yearlyChartData = computed(() => {
    ...
    typeMap.forEach((typeData, type) => {
        months.forEach(month => {
            const item = yearlyData.value?.find(
                d => d.statsMonth === month && d.assetsType === type
            )
