    ...
    <el-dialog title="报告异常" v-model="visible" width="500px" append-to-body @close="reset">
        <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
            <el-form-item label="故障说明" prop="failureName">
                <el-input v-model="form.failureName" show-word-limit clearable maxlength="120" placeholder="输入故障说明">
                </el-input>
            </el-form-item>
            <el-form-item label="故障时间" prop="failureDate">
                <el-date-picker v-model="form.failureDate" type="datetime" placeholder="输入设备异常出现时间"
                    value-format="YYYY-MM-DD HH:mm:ss" class="w100" />
            </el-form-item>
            <el-form-item label="故障描述" prop="failureDescription">
                <el-input v-model="form.failureDescription" type="textarea" show-word-limit clearable
                    placeholder="输入补充故障描述">
                </el-input>
            </el-form-item>
        </el-form>
        <template #footer>
...
import { DeviceEntity } from '@/api/itam/device'
