        ...
        <div v-else-if="deviceData" class="detail-content">
            ...
            <div class="overview-card">
                <div class="device-image">
                    <el-image v-if="deviceData.imageUrl" :src="deviceData.imageUrl"
                        :preview-src-list="[deviceData.imageUrl]" fit="cover" class="device-img" preview-teleported />
                    ...
                    <div class="info-section">
                        <el-descriptions :column="2" border>
                            ...
                            <el-descriptions-item label="购买成本">
                                <span v-if="deviceData.purchaseCost" class="cost-value">
                                    ¥{{ deviceData.purchaseCost }}
                                </span>
                                <span v-else>-</span>
                            </el-descriptions-item>
                ...
                <el-tab-pane label="关联资产" name="related">
                    <div class="info-section">
                        ...
                        <div class="related-section">
                            ...
                            <el-table v-if="deviceData.accessories?.length" :data="deviceData.accessories" stripe border
                                size="small">
                        ...
                        <div class="related-section">
                            ...
                            <el-table v-if="deviceData.licenses?.length" :data="deviceData.licenses" stripe border
                                size="small">
                                <el-table-column prop="name" label="名称" min-width="150" />
                        ...
                        <div class="related-section">
                            ...
                            <el-table v-if="deviceData.services?.length" :data="deviceData.services" stripe border
                                size="small">
                                <el-table-column prop="name" label="名称" min-width="150" />
                                <el-table-column prop="serviceNumber" label="服务编号" min-width="140" />
                                <el-table-column prop="offeringStatusDesc" label="状态" width="80">
                                    <template #default="{ row }">
                                        <el-tag :type="row.offeringStatus === 'normal' ? 'success' : 'warning'"
                                            size="small">
