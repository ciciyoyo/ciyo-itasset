    ...
    <el-dialog title="解决故障" v-model="visible" width="500px" append-to-body @close="reset">
        <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
            <el-form-item label="解决时间" prop="resolvedDate">
                <el-date-picker v-model="form.resolvedDate" type="datetime" placeholder="选择解决时间"
                    value-format="YYYY-MM-DD HH:mm:ss" class="w100" />
            </el-form-item>
            <el-form-item label="解决方案" prop="notes">
                <el-input v-model="form.notes" type="textarea" show-word-limit maxlength="500" placeholder="请输入解决方案">
                </el-input>
            </el-form-item>
        </el-form>
        <template #footer>
