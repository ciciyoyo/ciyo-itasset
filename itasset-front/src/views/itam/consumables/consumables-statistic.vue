<template>
  <div class="consumables-statistic p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-6">
      ...
      <ArtStatsCard title="总金额" :count="overviewData.totalAmount" icon="ri:money-cny-circle-line"
        icon-style="bg-purple-500" />
      <ArtStatsCard title="低库存预警" :count="overviewData.lowStockCount" icon="ri:alarm-warning-line"
        icon-style="bg-red-500" />
      <ArtStatsCard title="本月入库" :count="overviewData.monthStockIn" icon="ri:arrow-down-circle-line"
        icon-style="bg-cyan-500" />
      <ArtStatsCard title="本月出库" :count="overviewData.monthStockOut" icon="ri:arrow-up-circle-line"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div class="art-card h-100 p-5 mb-5 max-sm:mb-4">
        ...
        <ArtLineChart height="calc(100% - 30px)" :data="chartData" :xAxisData="xAxisData" :showLegend="true"
      ...
      <div class="art-card h-100 p-5 mb-5 max-sm:mb-4">
        ...
        <ArtRingChart :data="categoryDistributionData" :colors="['#4C87F3', '#93F1B4', '#8BD8FC', '#FFB84D', '#FF6B9D']"
          :radius="['46%', '60%']" :showLabel="true" :showLegend="true" />
      </div>
    </div>
  </div>
</template>
