        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="分类" prop="categoryId">
              <el-tree-select v-model="form.categoryId" :data="categoryTree" check-strictly :render-after-expand="false"
                placeholder="请选择分类" clearable node-key="id"
                :props="{ label: 'name', children: 'children', value: 'id' }" class="!w-full" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="总许可数" prop="totalSeats">
              <el-input-number v-model="form.totalSeats" placeholder="请输入总许可数" controls-position="right" :min="0"
                class="!w-full" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="最少数量" prop="minQty">
              <el-input-number v-model="form.minQty" placeholder="请输入最少数量" controls-position="right" :min="0"
                class="!w-full" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="购买日期" prop="purchaseDate">
              <el-date-picker clearable v-model="form.purchaseDate" type="datetime" value-format="YYYY-MM-DD HH:mm:ss"
          ...
          <el-col :span="12">
            <el-form-item label="到期日期" prop="expirationDate">
              <el-date-picker clearable v-model="form.expirationDate" type="datetime" value-format="YYYY-MM-DD HH:mm:ss"
                placeholder="请选择到期日期" class="!w-full">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="终止日期" prop="terminationDate">
              <el-date-picker clearable v-model="form.terminationDate" type="datetime"
                value-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择终止日期" class="!w-full">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="24">
