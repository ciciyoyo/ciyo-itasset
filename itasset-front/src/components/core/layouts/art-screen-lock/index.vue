  ...
  <div class="layout-lock-screen">
    ...
    <div v-else class="unlock-content">
      <div class="flex-c flex-col w-80">
        ...
        <ElForm ref="unlockFormRef" :model="unlockForm" :rules="rules" class="w-full !px-2.5" @submit.prevent="handleUnlock">
          <ElFormItem prop="password">
            <ElInput
          ...
          <div class="w-full text-center">
            <ElButton text class="mt-2.5 !text-g-600 hover:!text-theme hover:!bg-transparent" @click="toLogin">
