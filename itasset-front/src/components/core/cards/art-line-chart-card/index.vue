  ...
  <div class="art-card relative overflow-hidden" :style="{ height: `${height}rem` }">
    <div class="mb-2.5 flex-b items-start p-5">
      ...
      <div
        ...
        :class="[percentage > 0 ? 'text-success' : 'text-danger', isMiniChart ? 'absolute bottom-5' : '']"
      >
            ...
            areaStyle: props.showAreaColor
              ? {
                  color: new graphic.LinearGradient(0, 0, 0, 1, [
                    {
                      offset: 0,
                      color: props.color ? hexToRgba(props.color, 0.2).rgba : hexToRgba(getCssVar('--el-color-primary'), 0.2).rgba
                    },
                    {
                      offset: 1,
                      color: props.color
