...
public class TencentSmsServiceImpl extends SmsService {
    ...
    @Override
    public MsgSendResult sendSms(String phoneNumber, String templateId, Map<String, Object> templateParams) throws TencentCloudSDKException {
        ...
        req.setSignName(properties.getSign());
...
//        String[] phoneNumbers = {"+8621212313123", "+8612345678902", "+8612345678903"};
        ...
        /* 模板参数: 若无模板参数，则设置为空*/
        List<String> list = templateParams.values().stream().map(Convert::toStr).collect(Collectors.toList());
        ...
        return new MsgSendResult(true, SendSmsResponse.toJsonString(res));
    }
