package com.ciyocloud.datapermission.interceptor;

import com.baomidou.mybatisplus.core.plugins.InterceptorIgnoreHelper;
import com.baomidou.mybatisplus.core.toolkit.PluginUtils;
import com.baomidou.mybatisplus.extension.parser.JsqlParserSupport;
import com.baomidou.mybatisplus.extension.plugins.inner.InnerInterceptor;
import com.ciyocloud.datapermission.handler.PlusDataPermissionHandler;
...
public class PlusDataPermissionInterceptor extends JsqlParserSupport implements InnerInterceptor {
    ...
    protected void processSelect(Select select, int index, String sql, Object obj) {
        if (select.getPlainSelect() != null) {
            this.setWhere(select.getPlainSelect(), (String) obj);
            ...
            selectList.forEach(s -> this.processSelect(s, index, sql, obj));
        }
    }
