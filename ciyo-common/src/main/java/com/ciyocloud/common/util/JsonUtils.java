...
public class JsonUtils {
    ...
    public static <T> List<T> listToList(Object object, Class<T> clazz) {
        ...
        List<T> lst = null;
        try {
            lst = objectMapper.readValue(JsonUtils.objToJson(object), javaType);
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }
        return lst;
    ...
    public static JsonNode objToJsonNode(Object obj) {
        ...
        return jsonToJsonNode(objToJson(obj));
    }
     ...
     */
    public static <T> T objToObj(Object obj, TypeReference<T> clazz) {
        return objectMapper.convertValue(obj, clazz);
    }
