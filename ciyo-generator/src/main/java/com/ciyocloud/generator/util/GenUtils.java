...
import com.ciyocloud.generator.config.GenConfig;
...
public class GenUtils {
     ...
     * 初始化表信息
     */
    public static void initTable(GenTableEntity genTable, Long opeUserId) {
        ...
        genTable.setCreateBy(opeUserId);
    }
    ...
    public static String convertClassName(String tableName) {
        ...
        if (autoRemovePre && StringUtils.isNotEmpty(tablePrefix)) {
            String[] searchList = StringUtils.split(tablePrefix, SEPARATOR);
